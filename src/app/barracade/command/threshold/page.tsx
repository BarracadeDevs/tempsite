        ...
        {!access ? (
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="w-full bg-neutral-900 text-green-400 border border-green-700 rounded px-3 py-2 mt-2 mb-4 font-mono"
              autoFocus
            />
            <button type="submit" className="bg-green-700 text-black px-4 py-2 rounded font-bold">Unlock</button>
          </form>
        ) : (
